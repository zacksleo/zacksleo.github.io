...
![alt text](https://blog.shaohushuo.com/images/2025/10/29/image-4.png)
...
![alt text](https://blog.shaohushuo.com/images/2025/10/29/image.png)

添加时需要注意，监听需要输入内网 IP 地址，不能使用外网 IP

![alt text](https://blog.shaohushuo.com/images/2025/10/29/image-1.png)

按照上面的方式，添加 3 个入站规则，每个规则都使用不同的内网 IP 地址，这里的配置规则如下

![alt text](https://blog.shaohushuo.com/images/2025/10/29/image-2.png)
...
![alt text](https://blog.shaohushuo.com/images/2025/10/29/image-3.png)
...
![alt text](https://blog.shaohushuo.com/images/2025/10/29/image-5.png)

出站规则 2：

![alt text](https://blog.shaohushuo.com/images/2025/10/29/image-6.png)

出站规则 3：

![alt text](https://blog.shaohushuo.com/images/2025/10/29/image-7.png)
...
![alt text](https://blog.shaohushuo.com/images/2025/10/29/image-8.png)

InBoundTags 填写入站规则的Tag,本例中为 inbound-172.21.0.42:27762, Outbound Tag 为上面出站规则则设置的 Tag，本文这里面为 ip1

路由规则 2：

![alt text](https://blog.shaohushuo.com/images/2025/10/29/image-9.png)

InBoundTags 填写入站规则的Tag,本例中为 inbound-172.21.0.48:44061, Outbound Tag 为上面出站规则则设置的 Tag，本文这里面为 ip2

路由规则 3：

![alt text](https://blog.shaohushuo.com/images/2025/10/29/image-10.png)
...
![alt text](https://blog.shaohushuo.com/images/2025/10/29/image-11.png)


打开客户端中的服务器设置，进入修改页面，将内网 IP 地址，改成对应的公网 IP 地址：

![alt text](https://blog.shaohushuo.com/images/2025/10/29/image-12.png)

需要注意的是，内网 IP 地址和公网 IP 地址是一一对应的关系，不能弄混, 例如内网 IP 172.21.0.42，对应的公网 IP 地址为 47.76.XX.254，所以将客户端上的原 172.21.0.42 地址改为 47.76.XX.254。

![alt text](https://blog.shaohushuo.com/images/2025/10/29/image-13.png)
