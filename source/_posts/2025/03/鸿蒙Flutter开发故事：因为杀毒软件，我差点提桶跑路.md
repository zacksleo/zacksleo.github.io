...
![alt text](https://blog.shaohushuo.com/images/2025/03/04/image.png)


看起来一头雾水，于是我让他检查下环境，使用
`flutter doctor` 查看出现如下错误:

![alt text](https://blog.shaohushuo.com/images/2025/03/04/image-1.png)

看起来像是在 Dart 版本不对，经过询问发现，小天发现了 dart-sdk 是空的，于是手动复制了一份，查看错误输出，初步判断 dart-sdk 不匹配导致出错。那么问题来了，为什么目录为空？

![alt text](https://blog.shaohushuo.com/images/2025/03/04/image-2.png)
...
![alt text](https://blog.shaohushuo.com/images/2025/03/04/image-3.png)


此时退出命令，再次运行 `flutter doctor`，这次的输出不一样了

![alt text](https://blog.shaohushuo.com/images/2025/03/04/image-4.png)
...
![alt text](https://blog.shaohushuo.com/images/2025/03/04/image-5.png)
...
![alt text](https://blog.shaohushuo.com/images/2025/03/04/image-6.png)
...
![alt text](https://blog.shaohushuo.com/images/2025/03/04/image-7.png)
...
![alt text](https://blog.shaohushuo.com/images/2025/03/04/image-8.png)
