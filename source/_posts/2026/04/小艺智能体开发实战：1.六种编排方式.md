...
![alt text](/images/小艺智能体开发实战/image-1.png)
...
![alt text](/images/小艺智能体开发实战/image-2.png)

4. 多 Agent 模式

可在一个智能体中配置多个 Agent，以处理更加复杂的逻辑。

![alt text](/images/小艺智能体开发实战/image-3.png)
...
![alt text](/images/小艺智能体开发实战/image-4.png)

6. 端 A2A 模式

HarmonyOS应用内通过AgentAbility开发的智能体。

![alt text](/images/小艺智能体开发实战/image-5.png)
