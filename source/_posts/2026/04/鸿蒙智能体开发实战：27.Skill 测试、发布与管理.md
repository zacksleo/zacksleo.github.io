...
![Skill 测试发布流程示意图](/images/鸿蒙智能体开发实战/image-27.1.png)
...
![云插件测试与发布界面](/images/鸿蒙智能体开发实战/kb-27.1.png)

*上图展示了云插件的测试发布页面，开发者可以在发布前进行模拟集测试，确认插件功能正常后点击发布*

![MCP 插件发布界面](/images/鸿蒙智能体开发实战/kb-27.2.png)
...
- [灰度发布最佳实践](https://developer.huawei.com/consumer/cn/doc/service/canary-release-0000002493084596)
- [智能体监控指南](https://developer.huawei.com/consumer/cn/doc/service/agent-monitoring-0000002435989660)
- [小艺开放平台 - 控制台](https://developer.huawei.com/consumer/cn/hag/)
