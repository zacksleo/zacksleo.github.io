...
![Skill、Plugin、Workflow 三者关系示意图](https://blog.shaohushuo.com/images/鸿蒙智能体开发实战/image-25.1.png)
...
![小艺开放平台 MCP 插件创建界面](https://blog.shaohushuo.com/images/鸿蒙智能体开发实战/kb-25.1.png)

*上图展示了小艺开放平台中 MCP 插件的创建入口和基础配置界面，开发者可以在此定义插件的名称、描述和工具能力*

![小艺开放平台云插件创建界面](https://blog.shaohushuo.com/images/鸿蒙智能体开发实战/kb-25.2.png)
...
- [小艺开放平台 - 技能管理](https://developer.huawei.com/consumer/cn/celia)
