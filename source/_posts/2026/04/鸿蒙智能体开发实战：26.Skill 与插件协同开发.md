...
![Skill 与 Plugin 协同架构示意图](https://blog.shaohushuo.com/images/鸿蒙智能体开发实战/image-26.1.png)
...
![小艺开放平台插件管理界面](https://blog.shaohushuo.com/images/鸿蒙智能体开发实战/kb-26.1.png)

*上图展示了智能体编排页面中的插件添加入口，开发者可以在「编排 → 能力拓展 → 插件」中为智能体添加和管理插件能力*

![端插件配置界面](https://blog.shaohushuo.com/images/鸿蒙智能体开发实战/kb-26.2.png)
...
- [智能体编排指南](https://developer.huawei.com/consumer/cn/doc/service/ability-expansion-function-introduction-0000002437625858)
