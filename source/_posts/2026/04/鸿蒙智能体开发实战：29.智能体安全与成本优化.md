...
> **重要提示**：未完成备案和标识配置的智能体将无法通过上架审核，请务必在开发阶段就完成相关合规配置。更多详情请参考 [内容合规信息中 AI 生成合成内容标识和大模型备案 FAQ](https://developer.huawei.com/consumer/cn/doc/service/ai-content-label-faq-0000002529599489)。
...
- [智能体上架审核规范](https://developer.huawei.com/consumer/cn/doc/service/agent-review-0000002437625979)
