...
![A2A基础配置入口](https://blog.shaohushuo.com/images/鸿蒙智能体开发实战/kb-7.1.png)

### 基础配置详情

配置页面包含 API URL、会话维持方式、认证信息、方法声明等核心参数：

![A2A基础配置详情](https://blog.shaohushuo.com/images/鸿蒙智能体开发实战/kb-7.2.png)

### 输出设置

A2A 输出设置用于绑定响应卡片：

![A2A输出设置](https://blog.shaohushuo.com/images/鸿蒙智能体开发实战/kb-7.3.png)

### 绑定卡片

添加输出后可绑定具体卡片：

![A2A绑定卡片](https://blog.shaohushuo.com/images/鸿蒙智能体开发实战/kb-7.4.png)
...
除了云端A2A协议，鸿蒙还支持**端侧A2A协议**，用于小艺Client Agent与应用内Agent的直接通信。
...
**Context**是会话的逻辑容器，通过 `contextId` 唯一标识：
...
> 提示：Task的`taskId`由Agent在首帧响应中分配，任务终止后不可重启。
...
- [鸿蒙Agent通信协议消息参数说明 - 华为开发者联盟](https://developer.huawei.com/consumer/cn/doc/service/agent2agent-parameter-desc-0000002467479802)
- [端侧插件工具指令说明 - 华为开发者联盟](https://developer.huawei.com/consumer/cn/doc/service/agent2agent-action-0000002467539682)
- [设备上下文参数指令说明 - 华为开发者联盟](https://developer.huawei.com/consumer/cn/doc/service/agent2agent-context-0000002501019701)
- [底部快捷指令说明 - 华为开发者联盟](https://developer.huawei.com/consumer/cn/doc/service/agent2agent-command-0000002467900460)
- [SSE (Server-Sent Events) 规范](https://html.spec.whatwg.org/multipage/server-sent-events.html)
- [JSON-RPC 2.0 规范](https://www.jsonrpc.org/specification)

## 参考资源

- [鸿蒙 Agent 通信协议技术规范总览 - 华为开发者联盟](https://developer.huawei.com/consumer/cn/doc/service/agent2agent-comments-0000002500412353)
