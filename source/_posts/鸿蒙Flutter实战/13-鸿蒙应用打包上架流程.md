...
![alt text](https://blog.shaohushuo.com/images/鸿蒙Flutter实战/image-8.png)

### 新建APP ID

1.在 AppGalleryConnect，证书、APP ID 和 Profile 中。

![alt text](https://blog.shaohushuo.com/images/鸿蒙Flutter实战/image-6.png)

选择所属项目

![alt text](https://blog.shaohushuo.com/images/鸿蒙Flutter实战/image-9.png)

### 新建应用/元服务

在 APP ID 右侧，点击`发布`, 会弹出发布 HarmonyOS应用/元服务

![alt text](https://blog.shaohushuo.com/images/鸿蒙Flutter实战/image-10.png)
...
![alt text](https://blog.shaohushuo.com/images/鸿蒙Flutter实战/image-1.png)

2.如果没有创建 Key Store，则点击 New 创建一个

![alt text](https://blog.shaohushuo.com/images/鸿蒙Flutter实战/image-2.png)

选择需要存储的目录（文件扩展名使用.p12），输入密码8位以上的复杂密码，点击 OK。

3.设置 Key 的别名

![alt text](https://blog.shaohushuo.com/images/鸿蒙Flutter实战/image-3.png)

点击 Next 进入下一步

![alt text](https://blog.shaohushuo.com/images/鸿蒙Flutter实战/image-4.png)

设置 CSR 存储位置，注意文件名需要用 `.csr` 做为扩展名。

点击 Finished, 会创建 `.p12`密钥库文件以及 证书请求`.csr` 等文件。

![alt text](https://blog.shaohushuo.com/images/鸿蒙Flutter实战/image-5.png)
...
![alt text](https://blog.shaohushuo.com/images/鸿蒙Flutter实战/image-7.png)

2.`证书、App ID 和 Profile` 中的 `Profile`一栏，点击添加，创建 Profile 文件，选择刚才创建的证书

![alt text](https://blog.shaohushuo.com/images/鸿蒙Flutter实战/image-11.png)

### 打包 App

在 Deveco中，打开 File -> Project Structure -> Signing Configs, 默认会有一个创建过的 default 签名配置，点击 + 添加按钮，

![alt text](https://blog.shaohushuo.com/images/鸿蒙Flutter实战/image-12.png)

以此选择上面创建的 .p12文件、.p7b文件，以及下载的 .cer 文件，输入密码, 点击 `Apply` 生成配置。

![alt text](https://blog.shaohushuo.com/images/鸿蒙Flutter实战/image-13.png)
...
![alt text](https://blog.shaohushuo.com/images/鸿蒙Flutter实战/image-14.png)
